...
#include <ctype.h>
#include "imageio.h"
#include </usr/local/Cellar/zlib/1.2.8/include/zlib.h>

#ifdef USE_LIBPNG
#include </usr/local/Cellar/libpng/1.6.17/include/png.h>
...
#endif
#ifdef USE_LIBTIFF
#include </usr/local/Cellar/libtiff/4.0.3/include/tiffio.h>
#endif
#ifdef USE_LIBJPEG
#include </usr/local/Cellar/jpeg/8d/include/jpeglib.h>
#include <setjmp.h>
#endif
