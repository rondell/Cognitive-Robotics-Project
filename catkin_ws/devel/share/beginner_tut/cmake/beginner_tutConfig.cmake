...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tut_SOURCE_PREFIX /home/osboxes/Desktop/CR_project/Cognitive-Robotics-Project/catkin_ws/src/beginner_tut)
  set(beginner_tut_DEVEL_PREFIX /home/osboxes/Desktop/CR_project/Cognitive-Robotics-Project/catkin_ws/devel)
  ...
  set(beginner_tut_INSTALL_PREFIX /home/osboxes/Desktop/CR_project/Cognitive-Robotics-Project/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'beginner_tut' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'osboxes <osboxes@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'beginner_tut' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/osboxes/Desktop/CR_project/Cognitive-Robotics-Project/catkin_ws/src/beginner_tut/${idir}'.  Ask the maintainer 'osboxes <osboxes@todo.todo>' to fix it.")
    endif()
...
set(beginner_tut_EXPORTED_TARGETS "beginner_tut_generate_messages_cpp;beginner_tut_generate_messages_lisp;beginner_tut_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${beginner_tut_dep}_FOUND)
      find_package(${beginner_tut_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${beginner_tut_dep} REQUIRED ${depend_list})
  endif()
